...
<body>
	...
	<form action="PHA01-2.PHP" method="post">
		...
		<p>
			<input name="op[]" type="checkbox" value="+">三數相加&nbsp;&nbsp;
			<input name="op[]" type="checkbox" value="-">三數相減&nbsp;
			<input name="op[]" type="checkbox" value="*">三數相乘&nbsp;
			<input name="op[]" type="checkbox" value="/">三數相除
		</p>
