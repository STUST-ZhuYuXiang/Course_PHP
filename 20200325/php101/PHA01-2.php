...
<body>
  <embed src=<?php $_POST["music"]; ?> width=0 height=0>
  <div align="center">
    <p><img src="images/php01-6.gif" width="466" height="59" /></p>
  </div>
  <p class="style3">來自<a href="mailto:<?php $_POST["from_email"]; ?>"><?php $_POST["from_name"]; ?></a>的祝福：</p>
  <table width="80%" border="0" align="center" cellpadding="10" cellspacing="0">
    <tr>
      <td colspan="3" align="center"><?php echo "<img src='images/".$_POST["cardtype"]."'/>";  ?></td>
    </tr>
    <tr>
      <td height="40" colspan="2" align="left" bordercolor="1" bgcolor="#CCFFFF">
        <p align="left"><span class="style3">賀卡標題：<?php $_POST["subject"]; ?></span> <br />
        </p>
      </td>
    ...
    <tr>
      ...
      <td valign="top" bordercolor="1" bgcolor="#66FF99"><span class="style5" style="font-style:<?php echo $_POST["style"]; ?>;color:<?php echo $_POST["color"]; ?>;font-size:<?php echo $_POST["size"]; ?>;"><?php nl2br($_POST["message"]); ?></span></td>
      <td width="100" valign="top" bordercolor="1" bgcolor="#66FF99">&nbsp;</td>
    </tr>
  </table>
  <p>&nbsp;</p>
